...
export class BackendRoutes {
  ...
  static RoutePathGetTransactionSpendingLimitHexString =
...
export type OperationToCountMap<
  T extends CoinLimitOperationString | NFTLimitOperationString | AssociationOperationString
> = {
...
export class BackendApiService {
  ...
  GetAcceptedBidHistory(
    ...
    return this.get(
      endpoint,
      BackendRoutes.RoutePathGetAcceptedBidHistory + '/' + PostHashHex
    );
  }
  ...
  AuthorizeDerivedKey(
    ...
    let request = this.post(
      endpoint,
      BackendRoutes.RoutePathAuthorizeDerivedKey,
      {
  ...
  GetTransactionSpendingLimitHexString(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathGetTransactionSpendingLimitHexString,
      {
