...
export class UpdateProfileModalComponent implements OnInit, OnChanges {
  ...
  _updateProfileSuccess(comp: UpdateProfileModalComponent) {
  ...
  _updateProfileFailure(comp: UpdateProfileModalComponent) {
